...
<html>
    <head>
        ...
        <style>
            ...
            .container{
                ...
                box-shadow: 1px 1px 8px aliceblue;
                width: 50%;
            }
            .con{
                margin: 5px;
    ...
    <body>
        <form class="container" id="form1" method="GET">
            <h1 align="center" style="margin: 10px; color:rgb(214, 255, 192)">Transaction History</h1>
            <div class="con">
            ...
            <button type="submit" id="submit" class="butt" name="viewtrans">View Transaction History</button>
        </form>
    </body>
</html>
